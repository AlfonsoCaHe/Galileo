    ...
    $(document).ready(function() {
        ...
        $('#select-empresa').change(function() {
            ...
            if(empresaId) {
                ...
                $.get(url, function(data) {
                    $selectTutor.empty().append('<option value="">Seleccionar Tutor...</option>');
        ...
        function updateTutor(url, id) {
            $.ajax({
                url: url,
                method: 'PUT',
                data: { _token: "{{ csrf_token() }}", tutor_id: id },
                success: function() {
                    alert('Asignación guardada correctamente.'); // Puedes cambiarlo por un toast/notificación más bonita
                },
                error: function() {
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="mb-0 mt-1 texto">Proyecto: <strong class="text-info">{{ $proyecto->proyecto }}</strong></p>
        </div>
