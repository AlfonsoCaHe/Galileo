...
<div class="container my-5">
    ...
    <form action="{{ route('gestion.empresas.store') }}" method="POST">
        ...
        {{-- DATOS DE LA EMPRESA --}}
        <h3 class="mt-4 texto">Datos de la Empresa</h3>
        <hr>
        
        <div class="row">
            <div class="col-md-6 mb-3">
                <label for="cif_nif" class="form-label texto">CIF/NIF</label>
            ...
            <div class="col-md-6 mb-3">
                <label for="nombre" class="form-label texto">Nombre de la Empresa</label>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                <label for="nombre_gerente" class="form-label texto">Nombre del Gerente</label>
            ...
            <div class="col-md-6 mb-3">
                <label for="nif_gerente" class="form-label texto">NIF del Gerente</label>
        ...
        <h3 class="mt-5 texto">Datos del Tutor Laboral</h3>
        <hr>

        <div class="row">
            <div class="col-md-6 mb-3">
                <label for="tutor_nombre" class="form-label texto">Nombre</label>
            ...
            <div class="col-md-6 mb-3">
                <label for="tutor_email" class="form-label texto">Email (Acceso Usuario)</label>
