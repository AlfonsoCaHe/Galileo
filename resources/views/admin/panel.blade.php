...
<div class="container mt-5">
    ...
    <hr>
    <a href="{{ route('admin.proyectos') }}" class="btn btn-primary">Ir al Panel de Proyectos</a>
    <a href="{{ route('usuarios.show') }}" class="btn btn-primary">Ir al Listado de Usuarios</a>
    <a href="{{ route('gestion.empresas.index') }}" class="btn btn-primary">Ir al Listado de Empresas</a>
