        ...
        <div class="col-md-8 col-lg-5">
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body p-4 p-md-5">
                    <h2 class="card-title text-center mb-3 fw-bold text-primary">Nueva Tarea</h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('alumnado.storeTarea', ['proyecto_id' => $proyecto->id_base_de_datos]) }}" method="POST" novalidate>
                        @csrf

                        {{-- 1. Desplegable de Actividades --}}
                        <div class="mb-3">
                            <x-desplegable-actividades 
                                :proyecto-id="$proyecto->id_base_de_datos" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="notas_alumno" name="notas_alumno" class="form-control @error('notas_alumno') is-invalid @enderror" required>
                            @error('notas_alumno')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
