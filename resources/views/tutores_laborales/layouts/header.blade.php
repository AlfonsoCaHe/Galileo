            ...
            <div class="d-none d-lg-block">
                <div class="row g-2 justify-content-around">
                    ...
                    <div class="col-lg-3 col-xxl-2">
                        <a href="{{ route('tutores_laborales.panel') }}" class="btn btn-primary w-100 h-100 p-3 shadow-sm d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="col-lg-3 col-xxl-2">
                        <a href="{{ route('tutores_laborales.editar', auth()->user()->rolable_id) }}" 
            ...
            <div class="d-lg-none">
                <div class="dropdown">
                    <button class="btn btn-success w-100 d-flex justify-content-between align-items-center p-3 shadow-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="fw-bold text-uppercase"><i class="bi bi-list me-2"></i>Menú Desplegable</span>
                    </button>
                    <ul class="dropdown-menu w-100 shadow border-0 mt-1">
                        
                        {{-- Tutor Laboral --}}
                        <li>
                            <a class="dropdown-item py-2" href="{{ route('tutores_laborales.panel') }}">
                                <i class="bi bi-people-fill me-2 text-primary"></i> Alumnos
                            </a>
                        </li>

                        {{-- Datos Personales --}}
                        <li>
                            <a class="dropdown-item py-2" href="{{ route('tutores_laborales.editar', auth()->user()->rolable_id) }}">
