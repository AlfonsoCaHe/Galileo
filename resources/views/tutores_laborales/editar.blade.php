        ...
        <div class="col-md-8 col-lg-5">
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body p-4 p-md-5">
                    ...
                    <form action="{{ route('tutores_laborales.update', auth()->user()->rolable) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input id="email" name="email" type="email" autocomplete="email" required
                                   ...
                                   placeholder="tu.correo@ejemplo.com" disabled>
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-grid gap-2 mt-3">
                            <a href="{{ route('tutores_laborales.panel') }}" class="btn btn-danger btn-lg shadow-sm">
